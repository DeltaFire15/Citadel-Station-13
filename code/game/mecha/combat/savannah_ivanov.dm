 ...
 * ...Hilarious, right?
 */
/obj/mecha/combat/savannah_ivanov
...
/obj/mecha/combat/savannah_ivanov/get_mecha_occupancy_state()
...
/obj/mecha/combat/savannah_ivanov/auto_assign_occupant_flags(mob/new_occupant)
...
/obj/mecha/combat/savannah_ivanov/generate_actions()
	initialize_passenger_action_type(/datum/action/innate/mecha/swap_seat)
	. = ..()
	initialize_controller_action_type(/datum/action/innate/mecha/skyfall, VEHICLE_CONTROL_DRIVE)
	initialize_controller_action_type(/datum/action/innate/mecha/ivanov_strike, VEHICLE_CONTROL_EQUIPMENT)

/obj/mecha/combat/savannah_ivanov/remove_occupant(mob/getting_out)
 ...
 */
/obj/mecha/combat/savannah_ivanov/proc/begin_skyfall_charge(mob/pilot)
 ...
 */
/obj/mecha/combat/savannah_ivanov/proc/skyfall_charge_loop(mob/living/pilot)
	...
	var/datum/action/innate/mecha/savannah_action = occupant_actions[pilot][/datum/action/innate/mecha/skyfall]
	savannah_action.button_icon_state = "mech_savannah_cooldown"
	savannah_action.UpdateButtonIcon()
	addtimer(CALLBACK(savannah_action, /datum/action/innate/mecha/skyfall.proc/reset_button_icon), skyfall_cooldown_time)
 ...
 * * pilot: mob that activated the skyfall ability
 */
/obj/mecha/combat/savannah_ivanov/proc/begin_landing(mob/living/pilot)
 ...
 * * pilot: mob that activated the skyfall ability
 */
/obj/mecha/combat/savannah_ivanov/proc/land(mob/living/pilot)
 ...
 */
/obj/mecha/combat/savannah_ivanov/proc/abort_skyfall(mob/pilot)
	if(pilot)
 ...
 */
/obj/mecha/combat/savannah_ivanov/proc/start_missile_targeting(mob/gunner)
 ...
 * * silent: whether to send feedback messages.
 */
/obj/mecha/combat/savannah_ivanov/proc/end_missile_targeting(mob/gunner)
	aiming_ivanov = FALSE
	rockets_left = 0
...
/obj/mecha/combat/savannah_ivanov/proc/on_melee_click(datum/source, mob/living/pilot, atom/target, on_cooldown, is_adjacent)
	SIGNAL_HANDLER
	if(!target)
		return
...
/obj/mecha/combat/savannah_ivanov/proc/on_equipment_click(datum/source, mob/living/pilot, atom/target)
	SIGNAL_HANDLER
	if(!target)
		return
	drop_missile(pilot, get_turf(target))
 ...
 */
/obj/mecha/combat/savannah_ivanov/proc/drop_missile(mob/gunner, turf/target_turf)
	rockets_left -= 1
	if(rockets_left <= 0)
	...
	var/datum/action/innate/mecha/strike_action = occupant_actions[gunner][/datum/action/innate/mecha/ivanov_strike]
	strike_action.button_icon_state = "mech_ivanov_cooldown"
	strike_action.UpdateButtonIcon()
	addtimer(CALLBACK(strike_action, /datum/action/innate/mecha/ivanov_strike.proc/reset_button_icon), strike_cooldown_time)


///Savannah Skyfall
/datum/action/innate/mecha/skyfall
	name = "Savannah Skyfall"
	button_icon_state = "mech_savannah"

/datum/action/innate/mecha/skyfall/Trigger()
	if(!owner || !chassis || !(owner in chassis.occupants))
		return
	var/obj/mecha/combat/savannah_ivanov/savannah_mecha = chassis
 ...
 */
/datum/action/innate/mecha/skyfall/proc/reset_button_icon()
	button_icon_state = "mech_savannah"
	UpdateButtonIcon()

/datum/action/innate/mecha/ivanov_strike
	name = "Ivanov Strike"
	button_icon_state = "mech_ivanov"

/datum/action/innate/mecha/ivanov_strike/Trigger()
	if(!owner || !chassis || !(owner in chassis.occupants))
		return
	var/obj/mecha/combat/savannah_ivanov/ivanov_mecha = chassis
 ...
 */
/datum/action/innate/mecha/ivanov_strike/proc/reset_button_icon()
	button_icon_state = "mech_ivanov"
	UpdateButtonIcon()
...
/obj/effect/skyfall_landingzone
	...
	var/obj/mecha/combat/mecha

/obj/effect/skyfall_landingzone/Initialize(mapload, obj/mecha/combat/mecha)
	. = ..()
	src.mecha = mecha
