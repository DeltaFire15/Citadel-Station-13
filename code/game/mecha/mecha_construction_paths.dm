...
/datum/component/construction/mecha/savannah_ivanov
	...
	steps = list(
		...
		//5
		list(
			"key" = /obj/item/circuitboard/mecha/savannah_ivanov/main,
			"action" = ITEM_DELETE,
			"back_key" = TOOL_SCREWDRIVER,
			"desc" = "The wiring is adjusted."
		),
		...
		//7
		list(
			"key" = /obj/item/circuitboard/mecha/savannah_ivanov/peripherals,
			"action" = ITEM_DELETE,
			"back_key" = TOOL_SCREWDRIVER,
			"desc" = "Central control module is secured."
		),
		...
		//9
		list(
			"key" = /obj/item/circuitboard/mecha/savannah_ivanov/targeting,
			"action" = ITEM_DELETE,
			"back_key" = TOOL_SCREWDRIVER,
			"desc" = "Peripherals control module is secured."
		),
		...
		//20
		list(
			"key" = /obj/item/mecha_parts/part/savannah_ivanov_armor,
			"action" = ITEM_DELETE,
			"back_key" = TOOL_WELDER,
			"desc" = "Internal armor is welded."
		),
